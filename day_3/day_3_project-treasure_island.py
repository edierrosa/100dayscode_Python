...
if level_1 == "left":
    ...
    if level_2 == "wait":
        ...
        print("Killed by piranhas! You need to try harder mate!")
else:
    print("Either you've run into a venomous snake or typed a wrong entry.")
    print("In any case, that's the end of line. Have another go!")